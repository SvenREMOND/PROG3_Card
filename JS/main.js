...
h1.style.cssText = 'color: white; font-size: 50px; fontFamily: Poppins_EB; font-kerning: initial;';
...
var tagcolor = ['rgba(100, 128, 255, 0.6)', 'rgba(0, 128, 0, 0.6)', 'rgba(255, 166, 0, 0.6)'];
